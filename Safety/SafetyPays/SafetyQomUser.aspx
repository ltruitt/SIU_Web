...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="text/javascript" src="/Scripts/SafetyQomUser.js?0002"></script>  
 ...
 <div id="FormWrapper" class="ui-widget ui-form">
        ...
        <section class="ui-widget-header ui-corner-all" style="height: 45px;" >
            <a href="/MY/MyHome.aspx" style="text-decoration: none;">
                <span style="text-decoration: underline; font-style: italic; position: relative; left: 3px; vertical-align: top; font-size: .8em; line-height: 10px;">MySI page</span>
