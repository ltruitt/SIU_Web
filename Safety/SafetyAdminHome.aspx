...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
        ...
        <!-- Admin Tasks -->
        <div id="SafetyAdmin" class="AdminMenu"  style="background-color: white; margin-top: -0px; ">
			...
			<ul class="menu_gallery" style="background-color: transparent; ">
                ...
                <li style="height: 190px;  width: 150px; border: none; margin-right: 5px;">
                        <a href="SafetyPays/SafetyPays.aspx" >
						    <img  style="width: 150px; height: 75px; margin: 0px; padding-top: 10px; margin-bottom: 5px;"  alt="Safety Pays" src="/Images/SI-SafetyPays.png" />
					    </a>         
			...
			<ul>
                <li class="l3">
                    <a href="/Forms/SafetyQoMAdmin.aspx">
                        <div style="color: black; font-size: .9em;" id="SafetyPaysQomAdminLink">

                        </div>
                    </a>
                </li>
                <li class="l3">
                    <a href="/Forms/SafetyQoMAnsAdmin.aspx" >
                        <div id="SafetyQoMAnsAdminLink">Question Responses</div>
                    </a>
                </li>
			</ul>
            </div>      
