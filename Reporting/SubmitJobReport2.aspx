<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster2.master" AutoEventWireup="true" CodeFile="SubmitJobReport2.aspx.cs" Inherits="Reporting_SubmitJobReport2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script type="text/javascript" src="/Scripts/SubmitJobRpt2.js"></script>  
        ...
        <div id="FormWrapper" class="ui-widget ui-form">
            ...
            <section class="ui-widget-content ui-corner-all">
                ...
                <div style="float: left; width: 320px; ">
                    ...
                    <%--Job Loading--%>
                    <div id="jobLoadingDiv" style="margin-top: 20px; font-weight: bold; display:inline;">
                        <img id="ddJobNoWait" src="/Images/Loading2.gif"  style="height: 21px;"/>
                        <span style="margin-left: 5px; margin-right: 5px;">Please wait while Job</span><br/>
                        <span id="JobNoLookup" ></span>
                        <span style="margin-left: 5px;">is looked up</span>
                    </div>
                   ...
                   <section style="visibility: hidden;">
                        <span runat="server" id="hlblJobNo"></span>
                ...
                <div id="tabsESD1"style="float: right; width: 60%;">                   
                        ...
                        <section id="DispTab2" class="ui-state-error ui-corner-all" style="margin-top: 4px; width: 100%;"   >
                            ...
                            <div style="display: inline-block; width: 100%; margin-bottom: 5px; margin-top: 10px;">
                                ...
                                <div style="display: inline-block;   height: 40px;">
                                    <input type="text" id="dfsDelivDate" Class="DataInputCss DateEntryCss"   style="width: 100px; margin-top: 20px; "  />   
                                </div>
                            </div>
                ...
                <div id="tabsESD3"style="float: right; width: 60%;">                   
                    <ul>
                        <li><a href="#DispTab3">Disposition</a></li>
                    </ul>
                ...
                <div id="tabsMSD1"style="float: right; width: 60%;">                   
                    <ul>
                        <li><a href="#DispTab4">Disposition</a></li>
                    </ul>
                    ...
                    <div id="DispTab4">
                        <section id="Section6" class="ui-state-error ui-corner-all" style="margin-top: 4px; width: 100%;"   >
                            ...
                            <div id="Msd1Switches" style="margin-bottom: 2px; margin-left: -2px;"></div>
                ...
                <div id="tabsMSD3"style="float: right; width: 60%;">                   
                    <ul>
                        <li><a href="#DispTab6">Disposition</a></li>
                    </ul>
                ...
                <div id="tabsMSD4"style="float: right; width: 60%;">                   
                    <ul>
                        <li><a href="#DispTab7">Disposition</a></li>
                    </ul>
