<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster2.master" AutoEventWireup="true" CodeFile="TimeRpt.aspx.cs" Inherits="ELO_TimeRpt" %>
        ...
        <div id="FormWrapper" class="ui-widget ui-form">
            ...
            <section class="ui-widget-header ui-corner-all" style="height: 45px;" >
                <a href="/ELO/MainMenu.aspx" style="text-decoration: none;">
                    ...
                    <span  style="text-align: center; font-size: 2em; width: 100%;  position:absolute; left: 0; margin-left: auto; margin-right: auto;">Unposted Time</span>
                </a>
            </section>
            ...
            <section class="ui-widget-content ui-corner-all">
                ...
                <div style="float: left; margin-top: -20px; width: 100%;">
                    ...
                    <span ID="imgReport" runat="server"  style="float: right; margin-left: 7px; "  >
                        <a href="/ELO/TimeEntry.aspx" style="color:white; font-weight: bold;">Time Entry</a>
                    </span> 
                </div>
