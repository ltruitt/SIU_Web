$(document).ready(function () {
    ...
    NumericInput('Cost_inHouse');
    NumericInput('Cost_Incurred');
    NumericInput('Cost_Reserve');
    

    $('#Cost_inHouse').change(function () { calcTotal(); });
    $('#Cost_Incurred').change(function () { calcTotal(); });
    $('#Cost_Reserve').change(function () { calcTotal(); });
    
    function calcTotal() {
        var tot = Number(0);
        tot += Number(  $('#Cost_inHouse').val()  );
        tot += Number(  $('#Cost_Incurred').val() );
        tot += Number(  $('#Cost_Reserve').val()  );
        $('#Cost_Total').html(tot);
    }
    ...
    $('#jTableContainer').jtable({
        ...
        fields: {
            ...
            Disposition: {
                ...
                width: '1%',
                display: function (data) {
                    return data.record.iaList.Disposition;
                }
            },
        ...
        recordsLoaded: function () {
            $('tr:contains("Submit")').css("font-weight",  "bold").css("color", "Red");
    ...
    $("#btnSave").on("click", function () {
        ...
        submitIncidentAccidentAjax.add('_Emp_ID', $('#Emp_ID').html() );
    ...
    function validate() {
        ...
        if ( $('#Emp_Drug_Alchol_Test')[0].checked || $('#Emp_Comments').val() )
            $('#btnSubmit').show();
            
    }
    $('#Emp_Drug_Alchol_Test').change(function () { validate(); });
    $('#Emp_Comments').keyup(function () { validate(); });
